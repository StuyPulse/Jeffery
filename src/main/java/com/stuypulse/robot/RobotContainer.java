...
import com.stuypulse.robot.commands.alignment.FollowTrajectoryAlign;
import com.stuypulse.robot.commands.alignment.SwerveDriveToPose;
import com.stuypulse.robot.commands.alignment.SwerveDriveToPoseMP;
...
public class RobotContainer {
    ...
    private void configureButtonBindings() {
        ...
        driver.getBottomButton().whileTrue(new FollowTrajectoryAlign(swerve, new Pose2d(8,4, new Rotation2d(0))));
        // v is top button
        // z is bottom button
